...
// OptionProducer is an Option adjusts the configProducer for a producer.
...
func NewProducer(client redis.UniversalClient, stream string, options ...OptionProducer) *Producer {
	cfg := &configProducer{
		stream: stream,
	}
